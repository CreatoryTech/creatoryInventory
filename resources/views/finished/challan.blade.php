...
<div class="box  box-primary">
	...
	<form method="post" action="{{ route('factory.finished.challansave') }}" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
		...
		<label class="col-md-2 control-label">Product ID</label>
			<div class="col-md-8">
				<input name ='finished_id' placeholder ='Product ID' class="form-control">
			</div>
		</div>
		<div class="form-group">
